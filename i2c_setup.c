...
int main() {
    ...
    printf("Initializing I2C minimally...\n");

    // Set clock divider for a slower speed for testing purposes
    i2c[I2C_DIV / 4] = 0x60;  // Set clock divider to a slower rate (0x60)

    // Enable I2C without clearing FIFO (remove 0x8030 to avoid clearing FIFO)
    i2c[I2C_C / 4] = 0x00008000;  // Enable I2C only
