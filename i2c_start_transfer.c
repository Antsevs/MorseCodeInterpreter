...
int main() {
    ...
    i2c[I2C_C / 4] |= 0x8080;  // Start transfer by setting ST and CLEAR bits (0x8080)

    // Wait for Transfer to Complete
    printf("Waiting for I2C transfer to complete...\n");
    ...
    printf("I2C Control Register Value after transfer: 0x%08x\n", i2c_control);
